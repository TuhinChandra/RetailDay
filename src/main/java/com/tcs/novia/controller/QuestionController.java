...
public class QuestionController {
	...
	@RequestMapping(value = "/addQuestion/{questionID}", method = RequestMethod.POST, produces = "application/json")
	@ResponseBody
	public Question addQuestion(@PathVariable("questionID") final String questionID,
		...
		return questionService.createQuestion(questionID, questionText, optionA, optionB, optionC, optionD,
				optionCorrect);
	}
