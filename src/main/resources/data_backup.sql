...
--Password=Password01 which is equivalent to eDFqx0m2MlOfpKeRJ4AOJQg4yqs6G85+3tBBu70eB/c=
--INSERT INTO EMPLOYEE(NAME, EMAIL_ID,FOOD_PREFERENCE,PASSWORD,MOBILE,PHOTO) values('Tuhin Chandra','863841',0,'eDFqx0m2MlOfpKeRJ4AOJQg4yqs6G85+3tBBu70eB/c=',null,'abcd');

INSERT INTO event (event_id, event_name, event_details, start, finish, state, ppt_path, photo, duration) VALUES
